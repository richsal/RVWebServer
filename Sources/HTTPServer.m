...
{
    ProHTTPConnection *newConnection = (ProHTTPConnection *)[[connectionClass alloc] initWithAsyncSocket:newSocket
...
//	HTTPLogWarn(@"Failed to Publish Service: domain(%@) type(%@) name(%@) - %@", [ns domain], [ns type], [ns name], errorDict);
}
