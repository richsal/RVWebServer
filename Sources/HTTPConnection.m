		...
		else
		{
			...
			if (expectsUpload)
			{
				...
				else
				{
					...
					{
//						HTTPLogWarn(@"%@[%p]: Method expects request body, but had no specified Content-Length", THIS_FILE, self);
					...
					{
//						HTTPLogWarn(@"%@[%p]: Unable to parse Content-Length header into a valid number", THIS_FILE, self);
...
//						HTTPLogWarn(@"%@[%p]: Unable to parse Content-Length header into a valid number", THIS_FILE, self);
					...
					{
//						HTTPLogWarn(@"%@[%p]: Method not expecting request body had non-zero Content-Length", THIS_FILE, self);
